...
void TestResizePushBackPopBack() {
    const size_t ID = 42;
...
int main() {
    try {
        TestCapacitySizeReserve();
        TestOnThrow();
        TestAssignmentsAndMove();
        TestResizePushBackPopBack();
        TestEmplaceBack();
        TestInsertEraseEmplace();
        Benchmark();
